...
const HomePage = () => {
  ...
  const [environmentDescription, setEnvironmentDescription] = useState('Click on a land plot to get your farm judged by fasaan.')
  const [locationScore, setLocationScore] = useState ('?');
  const [locationDescription, setLocationDescription] = useState('Click on a land plot to get your farm judged by fasaan.')
  ...
  useEffect(async () => {
    const response = await fetch(
      'https://fasaan-api-iowa.herokuapp.com/data/earth',
      {
        method: 'GET',
        headers: {
